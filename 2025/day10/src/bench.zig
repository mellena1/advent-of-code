...
var test_manuals: std.ArrayList(day10.ManualLine) = undefined;

fn benchPart1(_: std.mem.Allocator) void {
    _ = day10.part1(test_manuals.items) catch unreachable;
}
...
pub fn main() !void {
    ...
    test_manuals = try day10.read_file(allocator, "input.txt");
    defer {
